...
export const ModelSettings = ({ isDarkMode = false }: ModelSettingsProps) => {
  ...
  const renderModelSelect = (agentName: AgentNameEnum) => (
    <div
      className={`rounded-lg border ${isDarkMode ? 'border-gray-700 bg-slate-800' : 'border-emerald-200 bg-emerald-50/40'} p-4`}>
          ...
          <div className="flex items-center">
            ...
            <div className="flex flex-1 items-center space-x-2">
              <input
                ...
                className={`flex-1 ${isDarkMode ? 'accent-emerald-500' : 'accent-emerald-400'} h-1 appearance-none rounded-full`}
              />
  ...
  return (
    <section className="space-y-6">
        ...
        <div className="space-y-6">
              ...
              return (
                <div
                  ...
                  <div className="space-y-3">
                        ...
                        <div className="flex items-center">
                          ...
                          <input
                            ...
                            className={`flex-1 rounded-md border p-2 text-sm ${nameErrors[providerId]
                              ...
                              : isDarkMode
                                ? 'border-emerald-700 bg-slate-700 text-gray-200 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-900'
                                : 'border-emerald-300 bg-gray-50 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200'
                              } outline-none`}
                          />
                        </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="relative flex-1">
                        <input
                          ...
                          className={`w-full rounded-md border text-sm ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-800' : 'border-gray-300 bg-white text-gray-700 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200'} p-2 outline-none`}
                        />
                        ...
                        <div className="flex flex-col">
                          <div className="flex items-center">
                            ...
                            <input
                              ...
                              className={`flex-1 rounded-md border text-sm ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-800' : 'border-gray-300 bg-white text-gray-700 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200'} p-2 outline-none`}
                            />
                          </div>
                        </div>
                      )}
                          ...
                          <div
                            ...
                            {(providerConfig.azureDeploymentNames || []).length > 0
                              ? (providerConfig.azureDeploymentNames || []).map((deploymentName: string) => (
                                <div
                                  key={deploymentName}
                                  className={`flex items-center rounded-full ${isDarkMode ? 'bg-emerald-900 text-emerald-100' : 'bg-emerald-100 text-emerald-800'} px-2 py-1 text-sm`}>
                                  <span>{deploymentName}</span>
                                  <button
                                    type="button"
                                    onClick={() => removeAzureDeployment(providerId, deploymentName)}
                                    className={`ml-1 font-bold ${isDarkMode ? 'text-emerald-300 hover:text-emerald-100' : 'text-emerald-600 hover:text-emerald-800'}`}
                    ...
                    {providerConfig.type === ProviderTypeEnum.Ollama && (
                      <div
                        className={`mt-4 rounded-md border ${isDarkMode ? 'border-slate-600 bg-slate-700' : 'border-emerald-100 bg-emerald-50'} p-3`}>
                        <p className={`text-sm ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>
                          <strong>
                            {' '}
                            <code
                              className={`rounded italic ${isDarkMode ? 'bg-slate-600 px-1 py-0.5' : 'bg-emerald-100 px-1 py-0.5'}`}>
                          ...
                          <a
                            ...
                            className={`ml-1 ${isDarkMode ? 'text-emerald-400 hover:text-emerald-300' : 'text-emerald-600 hover:text-emerald-800'}`}>
          ...
          <div className="provider-selector-container relative pt-4">
            <Button
              ...
              className={`flex w-full items-center justify-center font-medium ${isDarkMode
            ...
            {isProviderSelectorOpen && (
              <div
                className={`absolute z-10 mt-2 w-full overflow-hidden rounded-md border ${isDarkMode
                  ? 'border-emerald-600 bg-slate-700 shadow-lg shadow-slate-900/50'
                  : 'border-emerald-200 bg-white shadow-xl shadow-emerald-100/50'
                  }`}>
                <div className="py-1">
                  ...
                  {Object.values(ProviderTypeEnum)
                    ...
                    .map(type => (
                      <button
                        key={type}
                        type="button"
                        className={`flex w-full items-center px-4 py-3 text-left text-sm ${isDarkMode
                          ? 'text-emerald-200 hover:bg-emerald-600/30 hover:text-white'
      ...
      <div
        className={`rounded-lg border ${isDarkMode ? 'border-slate-700 bg-slate-800' : 'border-emerald-200 bg-emerald-50/40'} p-6 text-left shadow-sm`}>
