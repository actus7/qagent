...
AQgent is a browser extension that operates as an automated QA (Quality Assurance) agent. It runs multi-agent systems locally in the browser, supporting multiple LLM providers (OpenAI, Anthropic, Gemini, Ollama, etc.).
